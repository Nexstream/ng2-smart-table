...
(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('@angular/forms'), require('ng2-completer'), require('rxjs/Subject'), require('lodash'), require('mydaterangepicker'), require('@ng-bootstrap/ng-bootstrap'), require('rxjs/add/operator/debounceTime'), require('rxjs/add/operator/skip'), require('rxjs/add/operator/distinctUntilChanged'), require('@angular/http'), require('rxjs/add/operator/toPromise')) :
	typeof define === 'function' && define.amd ? define(['exports', '@angular/core', '@angular/common', '@angular/forms', 'ng2-completer', 'rxjs/Subject', 'lodash', 'mydaterangepicker', '@ng-bootstrap/ng-bootstrap', 'rxjs/add/operator/debounceTime', 'rxjs/add/operator/skip', 'rxjs/add/operator/distinctUntilChanged', '@angular/http', 'rxjs/add/operator/toPromise'], factory) :
	(factory((global['ng2-smart-table'] = global['ng2-smart-table'] || {}),global.ng.core,global.ng.common,global.ng.forms,global.ng2completer,global.Rx,global.lodash,global.mydaterangepicker,global._ngBootstrap_ngBootstrap,global.Rx.Observable.prototype,global.Rx.Observable.prototype,global.Rx.Observable.prototype,global.ng.http));
}(this, (function (exports,_angular_core,_angular_common,_angular_forms,ng2Completer,rxjs_Subject,lodash,mydaterangepicker,_ngBootstrap_ngBootstrap,rxjs_add_operator_debounceTime,rxjs_add_operator_skip,rxjs_add_operator_distinctUntilChanged,_angular_http) { 'use strict';
...
var Grid = (function () {
    ...
    Grid.prototype.setSource = function (source) {
        ...
        this.source.onChanged().subscribe(function (changes) {
            return _this.processDataChange(changes);
        });
        this.source.onUpdated().subscribe(function (data) {
            var changedRow = _this.dataSet.findRowByData(data);
            changedRow.setData(data);
        });
        this.source.onRequestData().subscribe(function (states) {
            _this.showLoading = states;
        });
    };
...
var DataSource = (function () {
    function DataSource() {
        ...
        this.onRequestSource = new rxjs_Subject.Subject();
    }
    ...
    DataSource.prototype.onRequestData = function () {
...
var FilterComponent = (function () {
    ...
    FilterComponent.prototype.onCustomFilter = function (query) {
...
var DefaultFilter = (function () {
    function DefaultFilter() {
        this.delay = 300;
        this.filter = new _angular_core.EventEmitter();
        this.customFilter = new _angular_core.EventEmitter();
    }
    ...
    DefaultFilter.prototype.setCustomFilter = function () {
...
__decorate$18([
    _angular_core.Output(),
    __metadata$15("design:type", Object)
], DefaultFilter.prototype, "customFilter", void 0);
...
var DateRangeFilterComponent = (function (_super) {
    __extends$11(DateRangeFilterComponent, _super);
    ...
    DateRangeFilterComponent.prototype.ngOnInit = function () {
        ...
        this.dateRange = this.formBuilder.group({
            ...
            myDateRange: [this.rangePickerModel, _angular_forms.Validators.required]
        });
...
var DatepickerFilterComponent = (function (_super) {
    __extends$12(DatepickerFilterComponent, _super);
    ...
    DatepickerFilterComponent.prototype.ngOnInit = function () {
        ...
        this.dateForm = this.fb.group({
            date: ['', _angular_forms.Validators.required]
        });
...
DatepickerFilterComponent = __decorate$23([
    _angular_core.Component({
    ...
    __metadata$20("design:paramtypes", [_angular_forms.FormBuilder])
...
FilterModule = __decorate$15([
    _angular_core.NgModule({
        imports: [
            ...
            ng2Completer.Ng2CompleterModule,
            mydaterangepicker.MyDateRangePickerModule,
...
PagerComponent = __decorate$25([
    _angular_core.Component({
        selector: 'ng2-smart-table-pager',
        styles: [".ng2-smart-pagination{display:inline-flex;font-size:.875em;padding:0;position:absolute}.ng2-smart-pagination .sr-only{position:absolute;width:1px;height:1px;padding:0;margin:-1px;overflow:hidden;clip:rect(0,0,0,0);border:0}.ng2-smart-pagination .ng2-smart-page-item{display:inline} /*# sourceMappingURL=pager.component.css.map */ "],
...
Ng2SmartTableTbodyComponent = __decorate$27([
    _angular_core.Component({
...
TbodyCreateCancelComponent = __decorate$28([
    _angular_core.Component({
...
TbodyEditDeleteComponent = __decorate$29([
    _angular_core.Component({
...
TbodyCustomComponent = __decorate$30([
    _angular_core.Component({
...
Ng2SmartTableTheadComponent = __decorate$32([
    _angular_core.Component({
...
ActionsComponent = __decorate$33([
    _angular_core.Component({
...
ActionsTitleComponent = __decorate$34([
    _angular_core.Component({
...
AddButtonComponent = __decorate$35([
    _angular_core.Component({
...
CheckboxSelectAllComponent = __decorate$36([
    _angular_core.Component({
...
ColumnTitleComponent = __decorate$37([
    _angular_core.Component({
...
TheadFitlersRowComponent = __decorate$39([
    _angular_core.Component({
...
TheadFormRowComponent = __decorate$40([
    _angular_core.Component({
...
TheadTitlesRowComponent = __decorate$41([
    _angular_core.Component({
...
var LocalDataSource = (function (_super) {
    __extends$13(LocalDataSource, _super);
...
var ServerDataSource = (function (_super) {
    __extends$14(ServerDataSource, _super);
...
var CustomServerDataSource = (function (_super) {
    __extends$15(CustomServerDataSource, _super);
...
exports.CustomServerDataSource = CustomServerDataSource;
