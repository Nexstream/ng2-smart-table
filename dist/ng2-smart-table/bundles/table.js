...
class Grid {
    ...
    setSource(source) {
        ...
        this.source.onRequestData().subscribe((states) => {
...
class DataSource {
    constructor() {
        ...
        this.onRequestSource = new Subject();
    }
    refresh() {
...
class DefaultFilter {
    constructor() {
        this.delay = 300;
        this.filter = new EventEmitter();
        this.customFilter = new EventEmitter();
    }
    ngOnDestroy() {
...
let DateRangeFilterComponent = class DateRangeFilterComponent extends DefaultFilter {
...
DateRangeFilterComponent = __decorate$22([
  ...
  `]
    ...
    __metadata$19("design:paramtypes", [FormBuilder])
...
let DatepickerFilterComponent = class DatepickerFilterComponent extends DefaultFilter {
    constructor(fb) {
        super();
        this.fb = fb;
        this.filterActive = false;
...
DatepickerFilterComponent = __decorate$23([
  ...
  `]
    ...
    __metadata$20("design:paramtypes", [FormBuilder])
